        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {equipments.map((item, index) => (
            <motion.div
              ...
              className="glass-panel rounded-3xl p-6 sm:p-8 border border-[#35A6B7]/30 hover:border-[#B8ED78]/60 shadow-xl glass-card-hover relative group flex flex-col justify-between overflow-hidden"
            >
              <div>
                {/* Equipment Real Image Header */}
                <div className="relative h-48 sm:h-56 w-full rounded-2xl overflow-hidden border border-[#35A6B7]/40 mb-6 bg-[#070C14]">
                  <img
                    src={item.image}
                    alt={item.name}
                  ...
                  <span className="absolute top-3 right-3 px-3 py-1 rounded-full text-xs font-bold bg-slate-950/80 text-[#B8ED78] border border-[#B8ED78]/40 backdrop-blur-md">
                    {item.category}
                  </span>
                </div>
