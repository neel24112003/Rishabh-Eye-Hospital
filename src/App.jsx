...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#070C14] text-slate-100 selection:bg-[#B8ED78] selection:text-slate-900 overflow-x-hidden relative">
      ...
      {/* Floating Quick Contact Widgets (Right Bottom - Theme Gradient Styled) */}
      <div className="fixed bottom-6 right-6 z-40 flex flex-col gap-3">
        {/* Official WhatsApp Floating Widget (Theme Gradient Styled) */}
        <a
          ...
          className="w-13 h-13 p-3 rounded-full bg-gradient-to-tr from-[#35A6B7] to-[#B8ED78] text-slate-950 shadow-2xl hover:scale-110 active:scale-95 transition-all duration-300 flex items-center justify-center border-2 border-white/20 group"
          title="Chat on WhatsApp (074055 63636)"
          aria-label="WhatsApp Chat"
        >
          <svg className="w-7 h-7 fill-slate-950 group-hover:rotate-12 transition-transform" viewBox="0 0 24 24">
